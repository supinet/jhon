...
public class JhonApp {

    private static final Logger log = LoggerFactory.getLogger(JhonApp.class);

    private final Environment env;

    public JhonApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhonApp.class);
